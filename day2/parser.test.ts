...
it('parses correctly a game', ( ) => {
    expect(parseLine('Game 1: 30 blue, 4 red; 1 red, 2 green, 6 blue; 2 green')).toEqual<Game>({
        id: 1,
        sets: [
...
it('parses correctly game 2', ( ) => {
    expect(parseLine('Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue')).toEqual<Game>({
        id: 2,
        sets: [
...
it('parses correctly a set of games', () => {
    expect(parseInput(`Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
    Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue`)).toEqual<Games>(
        [
            {
                id: 1,
                sets: [
